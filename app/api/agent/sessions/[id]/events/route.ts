...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  // response cannot be used to probe whether a session UUID exists. The owner is
  // the signed-in subject when an identity provider is configured, and the
  // anonymous cookie identity otherwise.
