...
export const ContextTrigger = ({ children, ...props }: ContextTriggerProps) => {
  const { usedTokens, maxTokens } = useContextValue();
  const usedPercent = usedTokens / maxTokens;
  const renderedPercent = new Intl.NumberFormat(currentLocale(), {
    style: 'percent',
...
export const ContextContentHeader = ({
  ...
  const { usedTokens, maxTokens } = useContextValue();
  const usedPercent = usedTokens / maxTokens;
  const displayPct = new Intl.NumberFormat(currentLocale(), {
    style: 'percent',
    maximumFractionDigits: 1,
  }).format(usedPercent);
  const used = new Intl.NumberFormat(currentLocale(), {
    notation: 'compact',
  }).format(usedTokens);
  const total = new Intl.NumberFormat(currentLocale(), {
    notation: 'compact',
  }).format(maxTokens);
...
export const ContextContentFooter = ({
  ...
  const costUSD = modelId
    ...
    : undefined;
  const totalCost = new Intl.NumberFormat(currentLocale(), {
    style: 'currency',
    currency: 'USD',
  }).format(costUSD ?? 0);
...
export const ContextInputUsage = ({ className, children, ...props }: ContextInputUsageProps) => {
  ...
  const inputCost = modelId
    ...
    : undefined;
  const inputCostText = new Intl.NumberFormat(currentLocale(), {
    style: 'currency',
    currency: 'USD',
  }).format(inputCost ?? 0);
...
export const ContextOutputUsage = ({ className, children, ...props }: ContextOutputUsageProps) => {
  ...
  const outputCost = modelId
    ...
    : undefined;
  const outputCostText = new Intl.NumberFormat(currentLocale(), {
    style: 'currency',
    currency: 'USD',
  }).format(outputCost ?? 0);
...
export const ContextReasoningUsage = ({
  ...
  const reasoningCost = modelId
    ...
    : undefined;
  const reasoningCostText = new Intl.NumberFormat(currentLocale(), {
    style: 'currency',
    currency: 'USD',
...
export const ContextCacheUsage = ({ className, children, ...props }: ContextCacheUsageProps) => {
  ...
  const cacheCost = modelId
    ...
    : undefined;
  const cacheCostText = new Intl.NumberFormat(currentLocale(), {
    style: 'currency',
    currency: 'USD',
  }).format(cacheCost ?? 0);
